...
parse_usage() {
    ...
    if echo "$json_data" | jq -e '.limited_user_quotas' >/dev/null 2>&1; then
        ...
        if [[ "$USE_COLOR" == "true" ]]; then
            ...
            echo "  ${cyan}13. gpt-5.2 1x${reset}"
            echo "  ${cyan}14. gpt-5.1 1x${reset}"
            echo "  ${cyan}15. gpt-5 1x${reset}"
            echo "  ${cyan}16. gpt-5.1-codex-mini 0.33x${reset}"
            ...
            echo "  14. gpt-5.1 1x"
            echo "  15. gpt-5 1x"
            echo "  16. gpt-5.1-codex-mini 0.33x"
